...
COPY requirements.txt .# Use slim Debian + Python 3.10 (MediaPipe wheels are built for this combo)
FROM python:3.10-slim-bookworm
...
# --- System libs needed by OpenCV/MediaPipe runtime ---
# [FIX] Install debian-archive-keyring first to fix GPG NO_PUBKEY errors
